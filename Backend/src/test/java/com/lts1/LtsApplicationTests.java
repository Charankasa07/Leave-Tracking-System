...
class LtsApplicationTests {
	...
	@Test
	@DisplayName("Should Retrieve all users data")
	public void shoudlRetrieveAllUsersData() throws URISyntaxException{
	...
	public void shouldGetLeavesBasedOnUserEmail() throws URISyntaxException{
		URI uri = new URI(baseUrl + port + "/employee/leaves/charan@edtex.in");
		ResponseEntity<Object> response = restTemplate.getForEntity(uri, Object.class);
		assertEquals(HttpStatus.OK,response.getStatusCode());
	}
	...
	public void shouldDeleteLeaveBasedOnId() throws URISyntaxException{
		URI uri = new URI(baseUrl + port + "/employee/leave/402");
	...
	public void shouldNotDeleteIfLeaveNotFound() throws URISyntaxException{
		URI uri = new URI(baseUrl + port + "/employee/leave/0");
		ResponseEntity<Object> response = restTemplate.exchange(uri, HttpMethod.DELETE, null, Object.class);
		assertEquals(HttpStatus.NO_CONTENT,response.getStatusCode());
	}
	...
	public void shoudlGetLeave() throws URISyntaxException{
	...
	public void shoudlReactToLeaves() throws URISyntaxException{
		URI uri = new URI(baseUrl + port + "/manager/leave/902/accepted");
		HttpEntity<String> request = new HttpEntity<String>("Accpeted by manager");
	...
	public void shouldUpdateLeaveCount() throws URISyntaxException{
		URI uri = new URI(baseUrl + port + "/manager/50");
